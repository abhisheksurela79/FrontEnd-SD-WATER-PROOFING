...
import "../components/css/developer.css"
...
function developer() {
  return (
    <>
      <section className="dev-head">
        ...
        <div>
          ...
          <div className="social-media-icons">
            ...
            <a href="https://github.com/abhisheksurela79" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="112"
                height="108.798"
            ...
            <a href="https://www.instagram.com/abhi_81718/" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.facebook.com/abhii.abhishekk/" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
                width="112.16"
      ...
      <section className="dev-content-2">
        <h3>Contact Information</h3>
        <p>Phone: +91 9205213241</p>
        <p>
          Email: abhisheksurela18@gmail.com
        </p>
        <p>
          LinkedIn:{" "}
          <a
